...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP ON pureftpd.* TO 'pureftpd'@'localhost' IDENTIFIED BY 'O2t11[A8yZj#';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP ON pureftpd.* TO 'pureftpd'@'localhost.localdomain' IDENTIFIED BY 'O2t11[A8yZj#';
FLUSH PRIVILEGES;
...
sudo mv /var/www/html/WebRepo/pureftpd-mysql.conf /etc/pure-ftpd/db/
