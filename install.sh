...
sudo openssl req -x509 -nodes -days 7300 -newkey rsa:2048 -keyout /etc/ssl/private/pure-ftpd.pem -out /etc/ssl/private/pure-ftpd.pem -subj "/C=IT/ST=Rome/L=Rome/O=MIM/OU=IT Computer Science Labs/CN=localhost.org/emailAddress=admin@localhost.org"
